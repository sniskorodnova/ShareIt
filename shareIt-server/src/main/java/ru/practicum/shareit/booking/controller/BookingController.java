...
public class BookingController {
    ...
    public BookingDto getById(@RequestHeader(value = "X-Sharer-User-Id") Long userId,
     ...
     */
    @GetMapping()
    public List<BookingDto> getAllBookingsForRequester(@RequestHeader(value = "X-Sharer-User-Id")
     ...
     */
    @GetMapping("/owner")
    public List<BookingDto> getAllBookingsForOwner(@RequestHeader(value = "X-Sharer-User-Id") Long userId,
