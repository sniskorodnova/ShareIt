...
public class ItemController {
     ...
     */
    @PostMapping
    public ItemDto create(@RequestHeader(value = BookingController.USER_HEADER_ID) Long userId,
                          @RequestBody ItemCreateDto itemCreate) throws UserNotFoundException, ValidationException {
     ...
     */
    @PatchMapping("/{id}")
    public ItemDto update(@RequestHeader(value = BookingController.USER_HEADER_ID) Long userId, @PathVariable Long id,
     ...
     */
    @GetMapping("/{id}")
    public ItemDtoWithComment getById(@RequestHeader(value = BookingController.USER_HEADER_ID) Long userId,
     ...
     */
    @GetMapping
    public List<ItemDtoWithComment> getAll(@RequestHeader(value = BookingController.USER_HEADER_ID) Long userId,
     ...
     */
    @GetMapping("/search")
    public List<ItemDto> searchByText(@RequestHeader(value = BookingController.USER_HEADER_ID) Long userId,
    ...
    public CommentDto createComment(@RequestHeader(value = BookingController.USER_HEADER_ID) Long userId,
